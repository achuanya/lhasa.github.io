...
![Alt text]({{ ARTICLEPICTURES_PATH }}/ubuntu-lock1.png){:.none}
...
![Alt text]({{ ARTICLEPICTURES_PATH }}/ubuntu-lock2.png "删除成功！") 
...
![Alt text]({{ ARTICLEPICTURES_PATH }}/ubuntu-lock3.png){:.none}
