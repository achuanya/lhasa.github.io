...
category: tech
thumb: 'ARTICLEPICTURES_PATH/git.jpg'
tags: [git, 分布式，管理控制系统]
---
...
![Alt text]({{ site.ARTICLEPICTURES_PATH }}/flow%20chart.jpg "Git数据流程图")  
 * **Workspace**：工作区
...
![Alt text]({{ site.ARTICLEPICTURES_PATH }}/rename.png?achuan.io "重命名操作")
...
![Alt text]({{ site.ARTICLEPICTURES_PATH }}/terminology.png "Git专业术语中英文对照表")
