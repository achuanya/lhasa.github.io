...
![Alt text]({{ ARTICLEPICTURES_PATH }}/flow%20chart.jpg "Git数据流程图")  
 * **Workspace**：工作区
...
![Alt text]({{ ARTICLEPICTURES_PATH }}/rename.png?achuan.io "重命名操作")
...
![Alt text]({{ ARTICLEPICTURES_PATH }}/terminology.png "Git专业术语中英文对照表")
